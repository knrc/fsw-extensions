...
public class SubsystemExtension implements Extension {
    public static final String SUBSYSTEM_NAME = "fsw-configuration";
    ...
    public void initializeParsers(final ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.FSW_CONFIGURATION_1_0.getUriString(), SubsystemParser_1_0.INSTANCE);
    }
}
