...
package org.jboss.integrationplatform.fsw.extension.deployment;
...
public interface SubsystemLogger extends BasicLogger {
     ...
     */
    public SubsystemLogger ROOT_LOGGER = Logger.getMessageLogger(SubsystemLogger.class, "org.jboss.integrationplatform.fsw.extension.deployment");
    ...
    @Message(id = 1005, value = "Activating FSW Deployment Extension")
