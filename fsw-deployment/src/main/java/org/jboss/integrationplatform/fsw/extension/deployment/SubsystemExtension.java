...
public class SubsystemExtension implements Extension {
    public static final String SUBSYSTEM_NAME = "fsw-deployment";
    ...
    public void initializeParsers(final ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, Namespace.FSW_DEPLOYMENT_1_0.getUriString(), SubsystemParser_1_0.INSTANCE);
    }
}
